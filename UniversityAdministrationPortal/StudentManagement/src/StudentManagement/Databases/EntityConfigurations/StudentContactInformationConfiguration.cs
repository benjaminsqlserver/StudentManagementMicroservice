...
public sealed class StudentContactInformationConfiguration : IEntityTypeConfiguration<StudentContactInformation>
{
    /// <summary>
    /// The database configuration for StudentContactInformations. 
    /// </summary>
