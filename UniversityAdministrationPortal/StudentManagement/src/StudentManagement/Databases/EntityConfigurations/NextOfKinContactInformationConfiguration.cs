...
public sealed class NextOfKinContactInformationConfiguration : IEntityTypeConfiguration<NextOfKinContactInformation>
{
    /// <summary>
    /// The database configuration for NextOfKinContactInformations. 
    /// </summary>
    public void Configure(EntityTypeBuilder<NextOfKinContactInformation> builder)
    {
