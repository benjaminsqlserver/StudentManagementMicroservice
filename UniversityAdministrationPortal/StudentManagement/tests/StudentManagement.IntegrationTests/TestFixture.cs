...
using StudentManagement.Extensions.Services;
using StudentManagement.Databases;
using StudentManagement.Resources;
using StudentManagement.SharedTestHelpers.Utilities;
...
public class TestFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        builder.Configuration.GetSection(ConnectionStringOptions.SectionName)[ConnectionStringOptions.StudentManagementKey] = connection;
    ...
    private static async Task RunMigration(string connectionString)
    {
        var options = new DbContextOptionsBuilder<StudentManagementDbContext>()
            ...
            .Options;
        var context = new StudentManagementDbContext(options, null, null, null);
